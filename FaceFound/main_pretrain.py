...
from utils.param import param_groups_weight_decay

from engine_pretrain import train_one_epoch
from mask_transform import MaskTransform

import utils.models_mae
import utils.models_mae_pvt
import utils.models_mae_swin
import utils.models_simmim_pvt
import utils.models_simmim_swin
...
def main(args):
    ...
    if 'mae_pvt' in args.model:
        model = utils.models_mae_pvt.__dict__[args.model](norm_pix_loss=args.norm_pix_loss, vis_mask_ratio=args.vis_mask_ratio)
    elif 'mae_swin' in args.model:
        model = utils.models_mae_swin.__dict__[args.model](norm_pix_loss=args.norm_pix_loss, vis_mask_ratio=args.vis_mask_ratio)
    elif 'simmim_pvt' in args.model:
        model = utils.models_simmim_pvt.__dict__[args.model](norm_pix_loss=args.norm_pix_loss)
    elif 'simmim_swin' in args.model:
        model = utils.models_simmim_swin.__dict__[args.model](norm_pix_loss=args.norm_pix_loss)
    else:
        model = utils.models_mae.__dict__[args.model](norm_pix_loss=args.norm_pix_loss, vis_mask_ratio=args.vis_mask_ratio)
